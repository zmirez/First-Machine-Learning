# -*- coding: utf-8 -*-
"""
Created on Thu Jul  5 01:20:24 2018
...
for j in range(0,len(img_file_name_list)-1):
    ...
    bgr=np.hstack((b,g,r))
    pca.fit(bgr)
    image=pca.transform(bgr)
    #img = cv2.merge([r_pca,g_pca,b_pca])
...
#グラフ用
history=model.fit(X_train,label_train,batch_size=32,epochs=50,verbose=1,validation_data=(X_test,label_test))
